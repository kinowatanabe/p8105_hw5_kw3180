...
* Power is the probability of rejecting the null when the alternative hypothesis is true. As the true mean (mu) increases, the effect size increases, and the power increases (proportional association). It is easier to detect larger effect sizes, so the power is greater.
